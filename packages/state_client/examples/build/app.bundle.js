...
const adapter = new _src_index__WEBPACK_IMPORTED_MODULE_0__.Adapter({
    url: SERVER_URL,
    userId: createPeerId()
});
adapter.addEventListener(_src_index__WEBPACK_IMPORTED_MODULE_0__.MessageType.UserJoined, (payload) => {
    console.log(payload);
});
