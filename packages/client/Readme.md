...
[Addons](../addons). For more details, see
...
Tiny Web Metaverse Client connects to the [`Stream server`](../stream_server)
...
Tiny Web Metaverse Client connects to the [`State server`](../state_server)
